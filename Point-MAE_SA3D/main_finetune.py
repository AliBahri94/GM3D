...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='./new_experiments_Feature_Based/2_PMAE_Chamfer_MSE_Feauture_based_lr_for_Hard_Patches_keep_ratio_0_5_G_64_N_32_Mask_ratio_6_2_decoders_chamfer_multiply_1000_seperate_learnable_tokens_shared_optimizer_for_loss_prediction_and_reconstruction_MODIFIED_2/finetune_modelnet40_new_opti_last_model_lr_5e_4_Modified_Batch_Size_1k',
                        help='path where to save, empty for no saving')
    parser.add_argument('--name_config', default='./finetune_modelnet.yaml',         #config_finetune_scan_hardest
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./new_experiments_Feature_Based/2_PMAE_Chamfer_MSE_Feauture_based_lr_for_Hard_Patches_keep_ratio_0_5_G_64_N_32_Mask_ratio_6_2_decoders_chamfer_multiply_1000_seperate_learnable_tokens_shared_optimizer_for_loss_prediction_and_reconstruction_MODIFIED_2/finetune_modelnet40_new_opti_last_model_lr_5e_4_Modified_Batch_Size_1k',
...
def main(args):
    ...
    if args.finetune:
        ...
        if args.teacher:
            ...
            #key = 'state_dict' if 'state_dict' in checkpoint else 'base_model'
        ...
        checkpoint_model = {k.replace("MAE_encoder.", ""): v for k, v in checkpoint_model.items()}     ### just for pointmae
